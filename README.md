...
Install / Uninstall
-------------------
Run the 'bootstrap' shell script and follow the
...
- Multiple chains : The chain number of each atom is printed in the 
	'atomOut' output. Using the option 'chainOut' prints the
	chain areas.
...
Phob/A^2 : solvent accessible surface area buried by hydrophobic neighbour
			atoms in Angstrom^2 units
Phil/A^2 : solvent accessible surface area buried by hydrophilic neighbour
			atoms in Angstrom^2 units
Total/A^2 : solvent accessible surface area buried by all neighbour
			atoms in Angstrom^2 units
...
Code
----
https://github.com/jkleinj/POPS


Releases
--------
https://github.com/jkleinj/POPS/releases
